...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _getImageFromGallery() async {
    ...
    if (pickedImage != null) {
      ...
      await uploadProfilePicture(_image!.path, int.parse(userId!));
  ...
  Future<void> uploadProfilePicture(String imagePath, int userId) async {
  ...
  //       // Simpan URL gambar di SharedPreferences
  //       await _saveImageProfile(profilePictureUrl)
  //           .then((value) => print('Save profile picture'));

  //       // Perbarui nilai imageUrl dan panggil setState
  //       setState(() {
